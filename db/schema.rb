...
ActiveRecord::Schema[7.2].define(version: 2025_10_11_204050) do
  ...
  create_table "video_chat_sessions", force: :cascade do |t|
    ...
    t.index ["status", "created_at"], name: "idx_video_chat_sessions_active"
    t.index ["user_id", "created_at", "status", "partner_user_id"], name: "idx_video_chat_sessions_recent_partners"
  ...
  create_table "video_waiting_rooms", force: :cascade do |t|
    ...
    t.index ["pool_id", "sequence_id", "status", "match_type", "room_id"], name: "idx_video_waiting_rooms_matching_optimized", where: "(((status)::text = 'waiting'::text) AND (room_id IS NULL))"
    ...
    t.index ["room_id", "status"], name: "idx_video_waiting_rooms_room_cleanup"
    ...
    t.index ["user_id", "status", "room_id"], name: "idx_video_waiting_rooms_user_status"
